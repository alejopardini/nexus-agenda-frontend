...
export default function Disponibilidad() {
  ...
  // Agrupar disponibilidad por profesional para la vista general
  const agrupadas = {}
  disponibilidades.forEach((d) => {
    if (!agrupadas[d.profesional]) agrupadas[d.profesional] = { nombre: d.profesional_nombre, items: [] }
    agrupadas[d.profesional].items.push(d)
  })
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          {Object.keys(agrupadas).length === 0 ? (
            ...
            <div className="space-y-3">
              {Object.entries(agrupadas).map(([profId, grupo]) => (
