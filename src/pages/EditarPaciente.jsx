...
export default function EditarPaciente() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([sucursalesRes, pacienteRes]) => {
        ...
        setForm({
          ...
          historia_clinica: pacienteRes.data.historia_clinica || '',
          discapacidad: pacienteRes.data.discapacidad || false,
          discapacidad_detalle: pacienteRes.data.discapacidad_detalle || '',
        })
      })
